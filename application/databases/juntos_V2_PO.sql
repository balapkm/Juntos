...
CREATE TABLE `material_details` (
  ...
  `discount_price_status` varchar(30) NOT NULL,
  `status` enum('Y','N') NOT NULL,
...
(5,	6,	'material-1',	'group',	'HSNCODE',	'PAIRS',	'INR',	560,	'Final',	0,	0,	8,	3,	'Percentage',	'Y'),
(6,	6,	'Material-2',	'group',	'HSNCODE',	'ODD',	'INR',	767,	'Final',	0,	0,	9,	3,	'Percentage',	'Y'),
(7,	7,	'Materila3',	'group2',	'HSNCODE1',	'PAIRS',	'INR',	678,	'Final',	8,	8,	0,	7,	'Percentage',	'Y'),
(8,	7,	'Material4',	'group',	'HSNCODE',	'PAIRS',	'INR',	658,	'Final',	8,	8,	0,	3,	'Percentage',	'Y');
...
INSERT INTO `po_generated_request_details` (`po_generated_request_id`, `unit`, `type`, `order_reference`, `po_number`, `po_date`, `delivery_date`, `supplier_id`, `material_id`, `material_name`, `material_hsn_code`, `qty`, `material_uom`, `currency`, `price`, `price_status`, `CGST`, `IGST`, `SGST`, `discount`, `discount_price_status`, `received`, `received_date`, `invoice_number`, `bill_amount`, `dc_number`, `created_date`) VALUES
(14,	'Upper',	'Indigenous',	'DD',	'2',	'2018-03-13',	'2018-03-19',	6,	5,	'material-1',	'HSNCODE',	100,	'PAIRS',	'INR',	560,	'Final',	0,	8,	0,	3,	'Percentage',	100,	'0000-00-00',	'',	80,	'',	'2018-03-04'),
(15,	'Upper',	'Indigenous',	'DD',	'2',	'2018-03-13',	'2018-03-19',	6,	6,	'Material-2',	'HSNCODE',	10,	'ODD',	'INR',	767,	'Final',	0,	9,	0,	3,	'Percentage',	1,	'0000-00-00',	'',	0,	'',	'2018-03-04'),
(16,	'Upper',	'Indigenous',	'GRM',	'3',	'2018-03-14',	'2018-03-22',	6,	5,	'material-1',	'HSNCODE',	0,	'PAIRS',	'INR',	560,	'Final',	0,	8,	0,	3,	'Percentage',	0,	'0000-00-00',	'',	0,	'',	'2018-03-05'),
(17,	'Upper',	'Indigenous',	'GRM',	'3',	'2018-03-14',	'2018-03-22',	6,	6,	'Material-2',	'HSNCODE',	0,	'ODD',	'INR',	767,	'Final',	0,	9,	0,	3,	'Percentage',	0,	'0000-00-00',	'',	0,	'',	'2018-03-05'),
(18,	'Full Shoe',	'Sample',	'DD',	'1',	'2018-03-21',	'2018-03-19',	7,	7,	'Materila3',	'HSNCODE1',	100,	'PAIRS',	'INR',	678,	'Final',	8,	0,	8,	7,	'Percentage',	0,	'0000-00-00',	'',	0,	'',	'2018-03-05'),
(19,	'Full Shoe',	'Sample',	'DD',	'1',	'2018-03-21',	'2018-03-19',	7,	8,	'Material4',	'HSNCODE',	10,	'PAIRS',	'INR',	658,	'Final',	8,	0,	8,	3,	'Percentage',	0,	'0000-00-00',	'',	0,	'',	'2018-03-05');
...
(6,	'Material Outstanding',	'material_outstanding',	'',	'Y');
...
(6,	'Test Suppliers',	'TESTSUPPLIER',	'',	'23,Jones street',	'',	'7845351015',	'balakumaran.raji@gmail.com',	'Ranipet',	'DEERS3434DD21',	'22',	'tax',	'Y'),
(7,	'Test Supplier - 2',	'TESTCODE',	'',	'23,Ammannayar street',	'',	'7845351015',	'balakumaran@gmaol.com',	'Ranipet',	'TERSD1231234NN',	'33',	'tax',	'Y');
