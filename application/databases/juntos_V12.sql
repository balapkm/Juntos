...
(5,	6,	4,	'TEST1',	'12',	'HHH1',	'PAIRS',	'INR',	12,	'FINAL',	0,	0,	2,	2,	'PERCENTAGE',	'Y'),
(7,	1,	2,	'MATERIAL NAME',	'21',	'HRML',	'PAIRS',	'INR',	1,	'FINAL',	1,	1,	0,	1,	'PERCENTAGE',	'Y'),
(8,	1,	2,	'MATERIAL NAME 1',	'TEST',	'DD',	'PAIRS1',	'INR',	2,	'FINAL',	2,	2,	0,	2,	'PERCENTAGE',	'Y'),
(9,	1,	3,	'MATERIAL NAME2',	'TEST',	'EER2',	'PAIRS1',	'INR',	1,	'APPROX',	1,	1,	0,	1,	'PERCENTAGE',	'Y'),
(10,	5,	3,	'MATERIAL NAME2',	'TEST',	'F',	'PAIRS1',	'INR',	2,	'FINAL',	2,	2,	0,	2,	'PERCENTAGE',	'Y'),
(11,	5,	2,	'MATERIAL NAME 1',	'TEST',	'HH',	'PAIRS1',	'INR',	1,	'FINAL',	0,	0,	1,	1,	'PERCENTAGE',	'Y'),
(12,	5,	4,	'TEST2',	'TEST',	'HH',	'PAIRS1',	'INR',	10,	'FINAL',	0,	0,	1,	1,	'PERCENTAGE',	'Y');
...
(44,	0,	'Upper',	'Indigenous',	'HELO',	'1',	'2018-04-18',	'2018-04-19',	1,	9,	3,	'MATERIAL NAME2',	'TES',	'EER2',	1.4,	'PAIRS1',	'INR',	1,	'APPROX',	1,	0,	1,	1,	'PERCENTAGE',	0,	'0000-00-00',	'0000-00-00',	'0000-00-00',	'',	0,	'0000-00-00',	'',	'',	'',	'',	'0000-00-00',	0,	'M',	'2018-04-14',	0,	''),
...
(1,	'Supplier Test1',	'SUTEST',	'',	'23,Amman Nayanar',	'',	'7845351015',	'balakumaran@gmail.com',	'Ranipet',	'33AAGDDDDDD',	'33',	'tax',	'',	'',	'',	'',	'',	'Y'),
(4,	'Supplier Test',	'c',	'',	'as',	'',	'8888',	'ab@gm.com',	's',	'skjdkjhk',	'22',	'tax',	'Registered',	'Test',	'',	'',	'',	'Y'),
(5,	'TEST',	'TEST',	'',	'TEST',	'',	'',	'',	'TEST',	'',	'12',	'TAX',	'REGISTERED',	'',	'',	'',	'',	'Y'),
(6,	'SUPPLIERNAME',	'TEST',	'',	'TEES',	'',	'131231311',	'',	'RANIPET',	'',	'22',	'TAX',	'REGISTERED',	'',	'',	'',	'',	'Y'),
(7,	'NEW SUPLLIER',	'AEASDS',	'D',	'F',	'F',	'12212',	'S@S.C',	'R',	'Q',	'D',	'TAX',	'REGISTERED',	'F',	'R',	'F',	'CHEQUE',	'Y');
