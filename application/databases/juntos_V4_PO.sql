...
(1,	'Upper',	'Import',	'1',	'2018-03-13',	'2018-03-13',	'EX-FACTORY',	'TT',	'DHC'),
...
CREATE TABLE `po_generated_request_details` (
  ...
  `SGST` float NOT NULL,
  `discount` float NOT NULL,
  `discount_price_status` enum('Percentage','Amount') NOT NULL,
...
INSERT INTO `po_generated_request_details` (`po_generated_request_id`, `parent_po_generated_request_id`, `unit`, `type`, `order_reference`, `po_number`, `po_date`, `delivery_date`, `supplier_id`, `material_id`, `material_name`, `material_hsn_code`, `qty`, `material_uom`, `currency`, `price`, `price_status`, `CGST`, `IGST`, `SGST`, `discount`, `discount_price_status`, `received`, `received_date`, `invoice_number`, `bill_amount`, `dc_number`, `outstanding_type`, `created_date`) VALUES
(1,	0,	'Upper',	'Import',	'GRML',	'1',	'2018-03-14',	'2018-03-15',	1,	1,	'Material -name',	'MATERHSN',	150,	'ODD',	'INR',	456,	'Final',	10,	4,	10,	3,	'Amount',	150,	'2018-03-11',	'',	0,	'',	'M',	'2018-03-11'),
(6,	1,	'Upper',	'Import',	'GRML',	'1',	'2018-03-14',	'2018-03-15',	1,	1,	'Material -name',	'MATERHSN',	150,	'ODD',	'INR',	456,	'Final',	10,	4,	10,	3,	'',	120,	'2018-03-11',	'',	0,	'',	'B',	'2018-03-11'),
(7,	1,	'Upper',	'Import',	'GRML',	'1',	'2018-03-14',	'2018-03-15',	1,	1,	'Material -name',	'MATERHSN',	150,	'ODD',	'INR',	456,	'Final',	10,	4,	10,	3,	'',	10,	'2018-03-11',	'',	0,	'',	'B',	'2018-03-11'),
(8,	1,	'Upper',	'Import',	'GRML',	'1',	'2018-03-14',	'2018-03-15',	1,	1,	'Material -name',	'MATERHSN',	150,	'ODD',	'INR',	456,	'Final',	10,	4,	10,	3,	'',	10,	'2018-03-11',	'',	0,	'',	'B',	'2018-03-11'),
(9,	1,	'Upper',	'Import',	'GRML',	'1',	'2018-03-14',	'2018-03-15',	1,	1,	'Material -name',	'MATERHSN',	150,	'ODD',	'INR',	456,	'Final',	10,	4,	10,	3,	'',	10,	'2018-03-11',	'',	0,	'',	'B',	'2018-03-11'),
(10,	0,	'Upper',	'Indigenous',	'GRM',	'1',	'2018-03-21',	'2018-03-22',	1,	1,	'Material -1',	'MATERHSN',	10,	'ODD',	'INR',	456,	'Final',	10,	4,	10,	3,	'Percentage',	0,	'0000-00-00',	'',	0,	'',	'M',	'2018-03-14'),
(11,	0,	'Upper',	'Indigenous',	'GRM',	'1',	'2018-03-21',	'2018-03-22',	1,	2,	'test',	'test',	120,	'PAIRS',	'INR',	567,	'Final',	4,	0,	4,	4,	'Percentage',	0,	'0000-00-00',	'',	0,	'',	'M',	'2018-03-14'),
(12,	0,	'Upper',	'Sample_Import',	'GFF',	'1',	'2018-03-21',	'2018-03-22',	1,	1,	'Material -1',	'MATERHSN',	0,	'ODD',	'INR',	456,	'Final',	10,	4,	10,	3,	'Percentage',	0,	'0000-00-00',	'',	0,	'',	'M',	'2018-03-15'),
(13,	0,	'Full Shoe',	'Sample_Indigenous',	'GRMR',	'1',	'2018-03-21',	'2018-03-23',	1,	1,	'Material -1',	'MATERHSN',	500,	'ODD',	'INR',	456,	'Final',	10,	4,	10,	3,	'Percentage',	190,	'2018-03-15',	'',	0,	'',	'M',	'2018-03-15'),
(15,	13,	'Full Shoe',	'Sample_Indigenous',	'GRMR',	'1',	'2018-03-21',	'2018-03-23',	1,	1,	'Material -1',	'MATERHSN',	500,	'ODD',	'INR',	456,	'Final',	10,	4,	10,	3,	'Percentage',	190,	'2018-03-15',	'',	0,	'',	'B',	'2018-03-15'),
(16,	0,	'Upper',	'Import',	'GRML',	'2',	'2018-03-17',	'2018-03-18',	1,	1,	'Material -1',	'MATERHSN',	0,	'ODD',	'INR',	456,	'Final',	10,	4,	10,	3,	'Percentage',	0,	'0000-00-00',	'',	0,	'',	'M',	'2018-03-16');
...
INSERT INTO `supplier_details` (`supplier_id`, `supplier_name`, `supplier_code`, `alt_supplier_name`, `supplier_address`, `alt_supplier_address`, `contact_no`, `email_id`, `origin`, `gst_no`, `state_code`, `supplier_tax_status`, `status`) VALUES
