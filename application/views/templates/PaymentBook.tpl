...
<div class="modal fade" id="advance_payment_remain_modal">
	<div class="modal-dialog modal-lg">
	    <div class="modal-content">
		    <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
		          <span aria-hidden="true">&times;</span></button>
		        <h4 class="modal-title">Edit Advance Payment data</h4>
		    </div>
		    <div class="modal-body">
		        <div class="row">
		            <div class="col-lg-4">
		                <div class="form-group">
		                  ...
		                  <input type="text" ng-model="advancePaymentRemain.payable_month" class="form-control" id="ard_payable_month" placeholder="Enter Payable Date">
		                </div>
		            </div>
		            <div class="col-lg-4">
		                <div class="form-group">
		                  <label for="exampleInputEmail1">Amount</label>
		                  <input type="text" ng-model="advancePaymentRemain.amount" class="form-control" id="ard_amount" disabled="disabled" placeholder="Enter Amount">
		                </div>
		            </div> 
		        </div>
		    </div>
	        <div class="modal-footer">
	        	<button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
        		<button type="button" class="btn btn-primary" ng-click="editAdvancePaymentRemainingAction()">Update</button>
	        </div>
	    </div>
	    <!-- /.modal-content -->
    </div>
